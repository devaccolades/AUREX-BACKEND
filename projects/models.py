...
class Projects(BaseModel):
    ...
    location_mapurl = models.CharField(max_length=1000, blank=True, null=True)
    ...
    slug = models.SlugField(max_length=200, default='projects', null=True, blank=True)
...
class CommonFacilities(BaseModel):
    ...
    class Meta:
        ...
        verbose_name_plural = "Common Facilities"
...
class LocationAdvantages(BaseModel):
    ...
    class Meta:
        ...
        verbose_name_plural = "Location Advantages"
